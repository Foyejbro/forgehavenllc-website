...
logo='data:image/png;base64,'+base64.b64encode((root/'public/assets/forge-haven-logo.png').read_bytes()).decode()
html=html.replace('/assets/forge-haven-logo.png',logo)
